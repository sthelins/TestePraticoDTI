...
public class main {
	...
	public static void main(String[] args) {
		...
		if(m == 1) {
			...
			System.out.println("mês inválido. Recomeçe!");
			System.exit(0);
		}
		...
		if(P1 < P2 && P1 < P3) {
			System.out.println("O melhor lugar será o Canino Feliz e o preço será R$" + P1);
		} else if (P2 < P1 && P2 < P1) {
			System.out.println("O melhor lugar será o Vai Rex e o preço será R$" + P2);
		} else if(P3 < P1 && P3 < P2) {
			System.out.println("O melhor lugar será o ChowChawgas e o preço será R$" + P3);
		} else if(P1 == P2 ) {
			System.out.println("O melhor lugar será o Vai Rex e o preço será R$" + P2);
		} else if(P1 == P3) {
			System.out.println("O melhor lugar será o ChowChawgas e o preço será R$" + P3);
